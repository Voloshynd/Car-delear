...
//Zapisywanie dannych z input do localStorage
...
let selectedDate;
$(function() {
        function getNext14WorkingDays(){
          let d = new Date();
          let day = d.getDay();
          if(day>=0 && day<=3) return 18;
          else if(day!=6) return 19;
          else return 20;
        }
        $("#datepicker").datepicker( { 
            ...
            maxDate: 14,
            dateFormat: "dd/mm/yy", 
            maxDate: "+"+getNext14WorkingDays()+"D",  
...
// Nawigacja wewnatrz listy akcesoriow
function selectAdd(){
...
SELECTED_ITEM_SUB.addEventListener("click", event =>{elem = event.target    
        id = elem.id;
